...
define('frontend/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('routes/userprofile.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/userprofile.js should pass ESLint\n\n');
  });
});
define('frontend/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('frontend/templates/flashcard.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'frontend/templates/flashcard.hbs should pass TemplateLint.\n\n');
  });
  ...
  QUnit.test('frontend/templates/userprofile.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'frontend/templates/userprofile.hbs should pass TemplateLint.\n\n');
  });
});
...
define('frontend/tests/unit/routes/flashcard-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  ...
  (0, _qunit.module)('Unit | Route | flashcard', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('frontend/tests/unit/routes/userprofile-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | userprofile', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:userprofile');
      assert.ok(route);
    });
  });
});
